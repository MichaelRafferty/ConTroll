                        ...
                        <form id='vendor_update' action='javascript:void(0)'>
                            <div class='row p-1'>
                                ...
                                <div class='col-sm-10 p-0'>
                                    <input class='form-control-sm' type='text' name='name' id='name' size='64' value="<?php echo str_replace('"', '\"', $info['name']); ?>" required/>
                                </div>
                            </div>
                            <div class='row p-1'>
                                <div class='col-sm-2 p-0'>
                                ...
                                <div class='col-sm-10 p-0'>
                                    <input class='form-control-sm' type='text' name='email' id='email' size='64' value="<?php echo str_replace('"', '\"', $info['email']); ?>" required/>
                                </div>
                            </div>
                            <div class="row p-1">
                                <div class="col-sm-2 p-0">
                                ...
                                <div class="col-sm-10 p-0">
                                    <input class='form-control-sm' type='text' name='website' id='website' value="<?php echo str_replace('"', '\"', $info['website']); ?>" required/>
                                </div>
                            </div>
                            <div class='row p-1'>
                                <div class='col-sm-2 p-0'>
                            ...
                            <div class="row mt-1">
                                ...
                                <div class="col-sm-auto p-0 ms-0 me-0">
                                    <input class="form-control-sm" id='addr' type='text' size="64" name='addr' value="<?php echo str_replace('"', '\"', $info['addr']); ?>" required/>
                                </div>
                            </div>
                            <div class="row mt-1">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-auto p-0 ms-0 me-0">
                                    <input class="form-control-sm" id='addr2' type='text' size="64" value="<?php echo str_replace('"', '\"', $info['addr2']); ?>" name='addr2'/>
                                </div>
                            </div>
                            <div class="row mt-1">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-auto p-0 ms-0 me-0">
                                    <input class="form-control-sm" id='city' type='text' size="32" value="<?php echo str_replace('"', '\"', $info['city']); ?>" name=' city' required/>
                                </div>
                                <div class="col-sm-auto ms-0 me-0 p-0 ps-2">
                                    <label for="state"> State: </label>
                                </div>
                                <div class="col-sm-auto p-0 ms-0 me-0 ps-1">
                                    <input class="form-control-sm" id='state' type='text' size="2" maxlength="2" value="<?php echo str_replace('"', '\"', $info['state']); ?>"
                                           name='state' required/>
                                </div>
                                <div class="col-sm-auto ms-0 me-0 p-0 ps-2">
                                    <label for="zip"> Zip: </label>
                                ...
                                <div class="col-sm-auto p-0 ms-0 me-0 ps-1 pb-2">
                                    <input class="form-control-sm" id='zip' type='text' size="11" maxlength="11" value="<?php echo str_replace('"', '\"', $info['zip']); ?>" name='zip'
                                           required/>
                                </div>
                            </div>
                        </form>
                ...
                <div class='modal-body' style='padding: 4px; background-color: lightcyan;'>
                    ...
                    <form id='vendor_invoice_form' class="form-floating" action='javascript:void(0);'>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 p-0">
                                <input class="form-control-sm" type='text' name='name' id='vendor_inv_name' value="<?php echo str_replace('"', '\"', $info['name']);  ?>" size="64" required/>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='col-sm-2'>
                            ...
                            <div class='col-sm-10 p-0'>
                                <input class='form-control-sm' type='text' name='email' id='vendor_inv_email' value="<?php echo str_replace('"', '\"', $info['email']); ?>" size="64" required/>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='col-sm-2'>
                            ...
                            <div class='col-sm-10 p-0'>
                                <input class='form-control-sm' type='text' name='addr' id='vendor_inv_addr' value="<?php echo str_replace('"', '\"', $info['addr']); ?>" size='64' required/>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='col-sm-2'>
                            ...
                            <div class='col-sm-10 p-0'>
                                <input class='form-control-sm' type='text' name='addr2' id='vendor_inv_addr2' value="<?php echo str_replace('"', '\"', $info['addr2']); ?>" size='64'/>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='col-sm-2'>
                            ...
                            <div class='col-sm-auto p-0 me-0'>
                                <input class='form-control-sm' id='vendor_inv_city' type='text' size='32' value="<?php echo str_replace('"', '\"', $info['city']); ?>" name=' city' required/>
                            </div>
                            <div class='col-sm-auto ms-0 me-0 p-0 ps-2'>
                                <label for='vendor_inv_state'> State: </label>
                            </div>
                            <div class='col-sm-auto p-0 ms-0 me-0 ps-1'>
                                <input class='form-control-sm' id='vendor_inv_state' type='text' size='2' maxlength='2' value="<?php echo str_replace('"', '\"', $info['state']); ?>"
                                       name='state' required/>
                            </div>
                            <div class='col-sm-auto ms-0 me-0 p-0 ps-2'>
                            ...
                            <div class='col-sm-auto p-0 ms-0 me-0 ps-1 pb-2'>
                                <input class='form-control-sm' id='vendor_inv_zip' type='text' size='11' maxlength='11' value="<?php echo str_replace('"', '\"', $info['zip']); ?>" name='zip'
                                       required/>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                         ...
                         <div class='row'>
                             ...
                             <div class='col-sm-auto'>
                                 <input type='text' id='cc_street' required='required' name='cc_addr' size='64' maxlength='64' value="<?php echo str_replace('"', '\"', $info['addr']); ?>"/>
                             </div>
                         </div>
                         <div class='row'>
                             <div class='col-sm-2'>
                             ...
                             <div class='col-sm-auto'>
                                 <input type='text' id='cc_city' required='required' size='35' name='cc_city' maxlength='64' vaue="<?php echo str_replace('"', '\"', $info['city']); ?>"/>
                             </div>
                             <div class='col-sm-auto ps-0 pe-0'>
                                 <label for='cc_state'>State:</label>
                             </div>
                             <div class='col-sm-auto'>
                                 <input type='text' id='cc_state' size=2 maxlength="2" required='required' name='cc_state' vaue="<?php echo str_replace('"', '\"', $info['state']); ?>"/>
                             </div>
                             <div class='col-sm-auto ps-0 pe-0'>
                                 <label for='cc_zip'>Zip:</label>
                             </div>
                             <div class='col-sm-auto'>
                                 <input type='text' id='cc_zip' required='required' size=10 maxlength="10" name='cc_zip' vaue="<?php echo str_replace('"', '\"', $info['zip']); ?>"/>
                             </div>
                         </div>
                         <div class='row'>
                             <div class='col-sm-2'>
                         ...
                         <div class="row">
                             ...
                             <div class="col-sm-auto">
                                  <input type='email' id='cc_email' name='cc_email' size="35" maxlength="64" value="<?php echo str_replace('"', '\"', $info['email']); ?>"/>
                             </div>
                         </div>
                         <div class='row'>
                            <div class='col-sm-12'>
