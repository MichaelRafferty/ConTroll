...
function getTabulatorIncludes(): array {
    return ( [
        'tabcss' => 'https://unpkg.com/tabulator-tables@6.5.0/dist/css/tabulator.min.css',
        'tabbs5' => 'https://unpkg.com/tabulator-tables@6.5.0/dist/css/tabulator_bootstrap5.min.css',
        'tabjs' => 'https://unpkg.com/tabulator-tables@6.5.0/dist/js/tabulator.min.js',
...
$portalJSVersion = '2.2.9';
$libJSversion = '2.2.15';
$controllJSversion = '2.2.11';
$globalJSversion = '2.2.4';
$atJSversion = '2.2.11';
$exhibitorJSversion = '2.2.7';
$onlineregJSversion = '2.2.1';
