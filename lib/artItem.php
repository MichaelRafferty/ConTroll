    ...
    */
    ...
    <div id='artItemEditPane'>
        <div class='container-fluid form-floating'>
            <form id="artItemEditor" method="POST">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-4" >
                        <select id="artItemLocation" name="location"> <!--populate from this artist's locations-->
                        </select>
                    </div>
                </div>
                <div class="row mb-2">
                    ...
                    <div class="col-sm-4" >
                        <input type="number" id="artItemQuantity" name="quantity"/> <!--max = original quantity-->
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="row mb-2">
                    <div class="col-sm-2">
                        <label for="artItemSalePrice" id="artItemSalePriceName">Quicksale/Sale Price/Ins Price:</label>
                    </div>
                    <div class="col-sm-auto" >
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-4" >
                        <input type="number" id="artItemFinalPrice" name="final"/> <!--only valid for some statuses -->
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="modal-footer">
            ...
            <button class='btn btn-sm btn-primary' id='profileSubmitBtn' onClick="artItemModal.updateArtItem()" >Submit</button>
        </div>
    </div>
    <?php
}
