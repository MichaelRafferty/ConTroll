    ...
    <form id='editForm' action='javascript:void(0)'>
      ...
      <table class='formalign'>
        ...
        <tbody id='editPersonFormName'>
            ...
            <tr>
                <td class='formfield'><input type="text" id='edit_fname' name="fname" size=20></input></td>
                <td class='formfield'><input type="text" id='edit_mname' name="mname" size=20></input></td>
                <td class='formfield' colspan=2><input type="text" id='edit_lname' name="lname" size=20></input></td>
                <td class='formfield'><input type="text" id='edit_suffix' name="suffix" size=4 maxlength=4></input></td>
            </tr>
            <tr>
                <td class='formlabel'>Badge Name</td>
            </tr>
            <tr>
                <td class='formfield'><input type="text" id='edit_badge' name="badge" size=20></input></td>
            </tr>
        </tbody>
        <tbody id='editPersonFormAddress'>
            ...
            <tr>
                <td class='formfield' colspan=4><input type="text" id='edit_addr' name="address" size=60></input>
            </tr>
            <tr>
                <td class='formlabel' colspan=4>Company/Address Line 2</td>
            </tr>
            <tr>
                <td class='formfield' colspan=4><input type="text" id='edit_addr2' name="addr2" size=60></input></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class='formfield' colspan=2><input type="text" id='edit_city' name="city" size=40></input></td>
                <td class='formfield'><input type="text" name="state" id='edit_state' size=2 maxlength=2></input></td>
                <td class='formfield'><input type="text" id='edit_zip' name="zip" size=5 maxlength=10></input></td>
            </tr>
            <tr>
                <td class='formlabel'>Country</td>
            </tr>
            <tr>
                <td class='formfield'><input type="text" id='edit_country' name="country" size="15" value="USA"></input></td>
            </tr>
        </tbody>
        <tbody id="editPersonFormContact">
            ...
            <tr>
                <td class='formfield' colspan=2><input type="text" id='edit_email' name="email" size=30></input></td>
                <td class='formfield' colspan=2><input type="text" id='edit_phone' name="phone" size=10></input></td>
                <td></td>
            </tr>
        </tbody>
        <tfoot id="editPersonFormButtons">
            <tr>
                <td colspan=5>
                    <input type="submit" value="Update Person" onClick='submitUpdateForm("#editForm", "scripts/editPerson.php", getEdited, null); $("#editDialog").dialog("close"); $("#editForm")[0].reset()'></input>
...
<div id='newPerson' class='popup'>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td><input type='text' name='fname' id='fname' required='required'></input></td>
        <td><input type='text' name='mname' id='mname'></input></td>
        <td><input type='text' name='lname' id='lname' required='required'></input></td>
        <td><input type='text' name='suffix' size=4 id='suffix'></input></td>
        <td class='separated' id='oname'></td>
        <td class='separated'>
          <label>Y<input type='radio' name='oname' value='Y'></input></label>
          <label>N<input type='radio' checked='checked' name='oname' value='N'></input></label>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan=4><input type='text' name='badge' id='obadge'></input></td>
        <td class='separated' id='obadge'></td>
        <td class='separated'>
          <label>Y<input type='radio' name='obadge' value='Y'></input></label>
          <label>N<input type='radio' checked='checked' name='obadge' value='N'></input></label>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan=4><input type='text' name='email' id='email' required='required'></input></td>
        <td class='separated' id='oemail'></td>
        <td class='separated'>
          <label>Y<input type='radio' name='oemail' value='Y'></input></label>
          <label>N<input type='radio' checked='checked' name='oemail' value='N'></input></label>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan=4><input type='text' name='phone' id='phone'></input></td>
        <td class='separated' id='ophone'></td>
        <td class='separated'>
          <label>Y<input type='radio' name='ophone' value='Y'></input></label>
          <label>N<input type='radio' checked='checked' name='ophone' value='N'></input></label>
        </td>
      </tr>
     <tr>
      ...
      <tr>
        <td colspan=4>
          <input type='text' name='address' id='addr' size=60 required='required'></input>
        </td>
        <td class='separated' id='oaddr' rowspan=4></td>
        <td class='separated' rowspan=4>
          <label>Y<input type='radio' name='oaddr' value='Y'></input></label>
          <label>N<input type='radio' checked='checked' name='oaddr' value='N'></input></label>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan=4>
          <input type='text' name='addr2' id='addr2' size=60></input>
        </td>
      ...
      <tr>
        ...
        <td>
          <input type='text' size=2 name='state' id='state' required='required'></input> /
          <input type='text' name='zip' id='zip' size=5 required='required'></input>
        </td>
        <td colspan=3>
