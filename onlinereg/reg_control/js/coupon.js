       ...
       this.#clearUsed(true);
        ...
        this.#couponTable = new Tabulator('#couponTable', {
            ...
            columns: [
                ...
                {title: "ID", field: "id", hozAlign: "right", maxWidth:70, width:70, headerSort: true, cellClick: rulesClicked, },
                ...
                {title: "#Used", field: "redeemedCount", hozAlign: "right", maxWidth:100, width:100, headerSort: true, headerFilter: true, cellClick: usedClicked, },
                {title: "#Keys", field: "keycount", hozAlign: "right", maxWidth:100, width:100, cellClick: keysClicked, },
