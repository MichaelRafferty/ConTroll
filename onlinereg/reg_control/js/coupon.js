       ...
       this.#clearUsed(true);
        ...
        this.#couponTable = new Tabulator('#couponTable', {
            ...
            columns: [
                ...
                {title: "#Used", field: "redeemedCount", hozAlign: "right", maxWidth:80, width:80, headerSort: true, headerFilter: true, cellClick: usedClicked, },
                {title: "#Keys", field: "keycount", hozAlign: "right", maxWidth:80, width:80, cellClick: keysClicked, },
