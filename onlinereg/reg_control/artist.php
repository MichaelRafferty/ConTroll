    ...
    <form id="artistForm" method="POST" action="javascript:void(0)">
      ...
      <table class='formalign'>
        ...
        <tbody id='artistInfo'>
          ...
          <tr>
            <td class='formfield'><input type='text' disabled id='fname'/></td>
            <td class='formfield'><input type='text' disabled id='mname'/></td>
            <td class='formfield'><input type='text' disabled id='lname'/></td>
            <td class='formfield'><input type='text' disabled id='suffix' size=4/></td>
          </tr>
          <tr>
