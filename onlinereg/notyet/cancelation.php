...
<body style='padding: 5px'>
    <div class="container-fluid">
        <img class="img-fluid" src="images/<?php echo $ini['logoimage']; ?>" alt="<?php echo $ini['logoalt'] ;?>"/>
    </div>
    ...
    if(!isset($_GET) or !isset($_GET['email']) or !isset($_GET['tid'])) {
      ...
      <?php
        ...
        Address:<br/>
            ...
            <input type='text' name='city' placeholder='City / State-Prov / Zip-PC'/> <input type='text' size=10 name='state'/> <input type='text' size=5
                                                                                                                                name='zip'/><br/>
