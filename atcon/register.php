...
<div id='initialDialog'>
    <form class='inline' id='fetchTransaction' method="GET" action="javascript:void(0)">
      ...
      <input type="submit" class='bigButton' id='fetchTransactionSubmit' value="Get Transaction" onclick='getForm("#fetchTransaction", "scripts/getTransaction.php", setTransaction, null)'></input>
    </form><br/>
<form class='inline' action='javascript:void(0)' id='createTransaction' method='GET'>
    ...
    <input type='submit' value='Search User' onClick='findToCreate("#createTransaction")'></input>
</form>
        ...
        <thead id='transactionFormId'>
          ...
          <tr>
            <td colspan=6 id='transactionFormOwnerBadgeActionButtons'>
              ...
              <button class='right badgeAction' id='transactionFormOwnerBadgeVolunteer' onclick='addBadgeAddon("volunteer", $("#transactionFormOwnerBadgeId").val(), "transactionFormOwner", "", true); return false;'>Volunteer</button>
              ...
              <button id='transactionFormOwnerBadgeYearAhead' class='badgeAction' onClick='addBadgeAddon("yearahead", $("#transactionFormOwnerBadgeId").val(), "transactionFormOwner", "", true); return false;'>YearAhead</button>
            </td>
          </tr>
        </thead>
