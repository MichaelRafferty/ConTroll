...
if(isset($_POST) && isset($_POST['type']) && $_POST['type'] == 'credit') {
    ...
    $paymentResponse = sendCC($amount, $_POST['track'], 'reg');

    unset($_POST['track']);

    if(!$paymentResponse['success']) {
        $paymentResponse['post'] = $_POST;
...
$response = json_decode(callHome("atconRegPayment.php", "POST", $data), true);
...
#ajaxSuccess(array($_POST, $response));
