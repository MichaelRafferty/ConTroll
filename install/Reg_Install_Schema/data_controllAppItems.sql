...
('portal','addUpgrade','main','step2','Custom Text for just after the Step 1 header'),
('portal','addUpgrade','main','step3','Custom Text for just after the Step 1 header'),
('portal','addUpgrade','main','step4','Custom Text for just after the Step 1 header'),
