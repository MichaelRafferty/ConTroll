...
CREATE TABLE `exhibitorYears` (
  ...
  `contactName` varchar(64) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `contactEmail` varchar(254) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `contactPhone` varchar(32) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `contactPassword` varchar(64) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
