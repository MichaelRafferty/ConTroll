...
$watchQ = <<<EOS
SELECT p.id AS perid, p.last_name, p.first_name, p.middle_name, p.suffix, p.email_addr, p.phone, p.badge_name, p.legalname, p.pronouns, 
...
FROM badgeList b
JOIN perinfo p ON (p.id = b.user_perid)
