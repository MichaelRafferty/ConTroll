...
EOQ;
    ...
    $email_html = returnCustomText('expire/html', null, false);
...
EOQ;
    ...
    $email_html = returnCustomText('noMembership/html', null, false);
...
EOQ;
    ...
    $email_html = returnCustomText('reminder/html', null, false);
...
EOQ;
    ...
    $email_html = returnCustomText('marketing/html', null, false);
...
EOQ;
    ...
    $email_html = returnCustomText('comeback/html', null, false);
    $email_subject = "We miss you! Please come back to $conname";
    $macroSubstitution = true;
    break;
...
EOQ;
    ...
    $email_html = returnCustomText('survey/html', null, false);
...
EOQ;
    ...
    $email_html = returnCustomText('invReminder/html', null, false);
    $macroSubstitution = true;
