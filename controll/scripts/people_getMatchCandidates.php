...
SELECT n.*, 'Y' as active, 'N' AS banned, r.regs, n.fullName, n.fullAddr, m.fullName AS manager,
...
SELECT DISTINCT spids.priority, p.*, r.regs, p.fullName, p.fullAddr, m.fullName AS manager, m.id AS managerId
FROM perinfo p
