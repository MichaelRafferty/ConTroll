            ...
            <div class='modal-content'>
                ...
                <div class='modal-body' style='padding: 4px; background-color: lightcyan;'>
                    <div class='container-fluid'>
                        <input type="hidden" id="eryID" name="eryID"/>
                        <div class="row mt-4">
                            <div class="col-sm-12">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-auto">
                                <select id="eryExhibitsRegion" name="eryExhibitsRegion">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class='col-sm-auto'>
                                <input type="text" id="eryOwnerName" name="eryOwnerName" maxlength="64" size="64"/>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class='col-sm-2'>&bigstar;Owner Email:</div>
                            <div class='col-sm-auto'>
                                <input type='text' id='eryOwnerEmail' name='eryOwnerEmail' maxlength='254' size="64"/>
                            </div>
                        </div>
                        <div class="row mt-2">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class='col-sm-auto'>
                                <input type='number' class='no-spinners' inputmode='numeric' id='eryTotalUnits' name='eryTotalUnits'/>
                            </div>
                        </div>
                        <div class="row mt-2">
