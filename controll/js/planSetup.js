    ...
    open() {
        ...
        this.#plansTable = new Tabulator('#paymentPlanTable', {
            ...
            columns: [
                ...
                {title: "% Down Payment", field: "downPercent", width: 80, headerSort: false, headerWordWrap: true, hozAlign: "right", },
                {title: "$ Down Payment", field: "downAmt", width: 100, headerSort: false, headerWordWrap: true, hozAlign: "right", },
                {title: "Min Payment", field: "minPayment", width: 100, headerSort: false, headerWordWrap: true, hozAlign: "right", },
                {title: "Max # Pmts", field: "numPaymentMax", width: 80, headerSort: false, headerWordWrap: true, hozAlign: "right", },
