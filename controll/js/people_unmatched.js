    ...
    showCandidates(data) {
        ...
        this.#newpersonTable = new Tabulator('#newpersonTable', {
            ...
            columns: [
                ...
                {title: "Pri", field: "priority", width: 100, headerHozAlign:"right", hozAlign: "right", headerSort: false, },
                {field: 'first_name', visible: false,},
                {field: 'middle_name', visible: false,},
                {field: 'last_name', visible: false,},
                {field: 'suffix', visible: false,},
        ...
        this.#candidateTable = new Tabulator('#candidateTable', {
            ...
            columns: [
                ...
                {title: "Pri", field: "priority", width: 100, headerHozAlign:"right", hozAlign: "right", },
                {field: 'first_name', visible: false,},
                {field: 'middle_name', visible: false,},
                {field: 'last_name', visible: false,},
                {field: 'suffix', visible: false,},
