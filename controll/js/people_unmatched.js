    ...
    draw(data, msg= null) {
        ...
        this.#unmatchedTable = new Tabulator('#unmatchedTable', {
            ...
            columns: [
                ...
                {title: "Managed By", field: "manager", headerWordWrap: true, width: 200, headerSort: true, headerFilter: true, formatter: "textarea", },
                {title: "Full Name", field: "fullName", width: 300, headerSort: true, headerFilter: true, formatter: "textarea" },
    ...
    showCandidates(data) {
        ...
        this.#newpersonTable = new Tabulator('#newpersonTable', {
            ...
            columns: [
                ...
                {title: "Full Name", field: "fullName", width: 250, headerSort: true, headerFilter: true, formatter: "textarea" },
