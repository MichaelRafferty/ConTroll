            ...
            columns: [
                {
                    title: label, columns: [
                        ...
                        {title: "Badge Name", headerWordWrap: true, field: "badgename", headerSort: true, headerFilter: true, formatter: 'html',},
            ...
            columns: [
                {
                    title: label, columns: [
                        ...
                        {title: "Used By:", columns: [
                            ...
                            {title: "Badge Name", headerWordWrap: true, field: "u_badgename", headerSort: true, headerFilter: true, formatter: 'html',},
                        ]},
                    ],
                },
            ],
