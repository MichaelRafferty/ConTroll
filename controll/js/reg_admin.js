...
function draw_registrations(data) {
    ...
    registrationtable = new Tabulator('#registration-table', {
        ...
        columns: [
            ...
            { title: "PID", field: "perid", width: 80, hozAlign: "right", headerSort: true, headerFilter: true, },
            { title: "NPID", field: "newperson_id", width: 80, hozAlign: "right", headerSort: true, headerFilter: true, },
            { title: "Mgr", field: "manager", width: 80, hozAlign: "right", headerSort: true, headerFilter: true, },
            ...
            { title: "mId", field: "memId", hozAlign: "right", headerSort: true, headerFilter: true, },
