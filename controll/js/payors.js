...
class Payors {
    ...
    draw() {
        ...
        this.#payorsTable = new Tabulator('#paymentPlanTable', {
            ...
            columns: [
                ...
                {title: "Initial Amt", field: "initalAmt", headerWordWrap: true, width: 100,
                    headerFilter: true, headerFilterFunc: numberHeaderFilter, },
                {title: "Non Plan Amt", field: "initalAmt", width: 100, headerWordWrap: true, headerFilter: true,
                    headerFilterFunc: numberHeaderFilter, },
                ...
                {title: "Days Btwn", field: "daysBetween", width: 65, headerWordWrap: true, headerFilter: true,
                    headerFilterFunc: numberHeaderFilter, },
                {title: "Pay By Date", field: "payByDate", width: 100, headerWordWrap: true, headerFilter: true, },
                ...
                {title: "Bal Due", field: "balanceDue", width: 100, headerWordWrap: true, headerFilter: true,
                    headerFilterFunc: numberHeaderFilter, },
                {title: "Create Date", field: "createDate", width: 100, headerWordWrap: true, headerFilter: true, headerSort: true, },
                {title: "Pmts Made", field: "paymentsMade", width: 65, headerWordWrap: true, headerFilter: true,
                    headerFilterFunc: numberHeaderFilter, },
                {title: "Last Pmt Date", field: "lastPaymentDate", width: 100, headerWordWrap: true, headerFilter: true, headerSort: true, },
